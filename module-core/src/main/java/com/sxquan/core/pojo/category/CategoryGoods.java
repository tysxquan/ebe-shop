package com.sxquan.core.pojo.category;
...
@ApiModel(value="category_goods对象", description="商品分类表")
public class CategoryGoods implements Serializable {
     ...
     * 分类图片子路径
     */
    public static final String CATEGORY_IMG_SUB_PATH = "/images/category/goods/";
