...
layui.define(['laypage', 'form'], function (exports) {
    ...
    IconPicker.prototype.render = function (options) {
        var opts = options,
            ...
            TITLE = 'layui-selectIcon-title',
            TITLE_ID = 'layui-selectIcon-title-' + tmp,
        ...
        var a = {
            ...
            toggleSelect: function () {
                ...
                a.event('click', item, function (e) {
                    var $icon = $('#' + ICON_BODY);
                    $icon.find(".layui-iconpicker-item").removeClass("admin-form-danger");
                    console.log()
            ...
            check: function () {
                ...
                a.event('click', item, function (e) {
                    ...
                    var clsArr = el.attr('class').split(/[\s\n]/),
                        cls = clsArr[1],
                        icon = cls;
                    console.log($('#' + TITLE_ID).find('.layui-iconpicker-item .layui-icon'))
                    $('#' + TITLE_ID).find('.layui-iconpicker-item>.layui-iconpicker-icon>.layui-icon').attr('class', clsArr.join(' '));
     ...
     * @param filter lay-filter
     */
    IconPicker.prototype.refresh = function (filter) {
        var el = $('*[lay-filter='+ filter +']'),
            p = el.next().find('.layui-iconpicker-item .layui-icon');
        el.val(null);
        p.removeAttr("class").addClass("layui-icon ");
    };
