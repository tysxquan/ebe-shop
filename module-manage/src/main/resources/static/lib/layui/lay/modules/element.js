...
;layui.define("jquery", function (t) {
    ...
    s.prototype.set = function (t) {
        ...
        //todo 修改layui-tab-content的位置添加了parent()
        var e = ".layui-tab-title", l = a(".layui-tab[lay-filter=" + t + "]"), n = l.children(e),
            s = n.children(".layui-tab-bar"), o = l.parent().children(".layui-tab-content"),
        ...
        y = "layui-nav-more", h = "layui-anim layui-anim-upbit", f = {
            tabClick: function (t, i, s, o) {
                ...
                var r = s || a(this), i = i || r.parent().children("li").index(r),
                    c = o.headerElem ? r.parent() : r.parent().parents(".layui-tab").eq(0),
                    u = o.bodyElem ? a(o.bodyElem) : c.parent().children(".layui-tab-content").children(".layui-tab-item"),
                ...
                var n = i || a(this).parent(), s = n.index(), o = n.parents(".layui-tab").eq(0),
                    r = o.parent().children(".layui-tab-content").children(".layui-tab-item"), c = o.attr("lay-filter");
                ...
                a(".layui-tab").each(function () {
                    var s = a(this), o = s.children(".layui-tab-title"),
                        r = (s.parent().children(".layui-tab-content").children(".layui-tab-item"), 'lay-stope="tabmore"'),
