package com.sxquan.manage.common.constant;

/**
 * @author sxquan
 * @since 2020/5/21 14:37
 */
public class GeneratorConstant {
     ...
     * 数据库名称
     */
    public static final String DATABASE_NAME = "ebe_base";


    /**
     * 生成代码的临时目录
     */
    public static final String TEMP_PATH = "ebe_gen_temp/";
