...
public class IpAddrUtil {
    ...
    public static String getCityInfo(String ip) {
        ...
        try {
            //db
            String dbPath = IpAddrUtil.class.getResource("/ip2region/ip2region.db").getPath();
            ...
            if (!file.exists()) {
                ...
                InputStream resourceAsStream = IpAddrUtil.class.getClassLoader().getResourceAsStream("classpath:ip2region/ip2region.db");
